...
本书是对图斯克语语法的详细描述，主要参考了黑蔑特地区的海峡图斯克语，也即图斯克帝国目前通行的官方语言。
...
第三类是物质名词，表示某些不可数的物质或材料，这一类名词在作形态变化时有特殊的处理方式：大多数的物质名词强制绑定复数形式，在涉及对该种类物质的描述时，通常加上黏着的后缀“=lis”，这在后文的名词派生中也有提到，但并不是所有能够通过“=lis”派生的名词都属于这一类，例如“wise”树，这一个名词就是一个具体名词。
